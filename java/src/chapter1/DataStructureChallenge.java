...
public class DataStructureChallenge {
    ...
    public static void main(String[] args) {
        ...
        String myString = "I love playing the guitar but never ever fucking do the fucking thing in my guitar guitar";
        mostRepeatedWordsInString(testString3);
    }
    ...
    public static void mostRepeatedWordsInString(String input) {
        ...
        for (String key : words) {
            if (wordsMap.containsKey(key) && !isItCommonWord(key)) {
                wordsMap.put(key, wordsMap.get(key) + 1);
            }else if (!isItCommonWord(key)){
                wordsMap.put(key, 1);
            }
        }
    ...
    public static boolean isItCommonWord(String s) {
